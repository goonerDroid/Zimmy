...
import com.sublime.zimmy.helpers.MediaButtonIntentReceiver;
import com.sublime.zimmy.helpers.MusicPlaybackTrack;
import com.sublime.zimmy.lastfmapi.LastFmClient;
import com.sublime.zimmy.lastfmapi.models.LastfmUserSession;
import com.sublime.zimmy.lastfmapi.models.ScrobbleQuery;
import com.sublime.zimmy.permissions.Nammu;
import com.sublime.zimmy.provider.MusicPlaybackState;
import com.sublime.zimmy.provider.RecentStore;
import com.sublime.zimmy.provider.SongPlayCount;
...
public class MusicService extends Service {
    public static final String PLAYSTATE_CHANGED = "com.sublime.zimmy.playstatechanged";
    public static final String POSITION_CHANGED = "com.sublime.zimmy.positionchanged";
    public static final String META_CHANGED = "com.sublime.zimmy.metachanged";
    public static final String QUEUE_CHANGED = "com.sublime.zimmy.queuechanged";
    public static final String PLAYLIST_CHANGED = "com.sublime.zimmy.playlistchanged";
    public static final String REPEATMODE_CHANGED = "com.sublime.zimmy.repeatmodechanged";
    public static final String SHUFFLEMODE_CHANGED = "com.sublime.zimmy.shufflemodechanged";
    public static final String TRACK_ERROR = "com.sublime.zimmy.trackerror";
    public static final String TIMBER_PACKAGE_NAME = "com.sublime.zimmy";
    public static final String MUSIC_PACKAGE_NAME = "com.android.music";
    public static final String SERVICECMD = "com.sublime.zimmy.musicservicecommand";
    public static final String TOGGLEPAUSE_ACTION = "com.sublime.zimmy.togglepause";
    public static final String PAUSE_ACTION = "com.sublime.zimmy.pause";
    public static final String STOP_ACTION = "com.sublime.zimmy.stop";
    public static final String PREVIOUS_ACTION = "com.sublime.zimmy.previous";
    public static final String PREVIOUS_FORCE_ACTION = "com.sublime.zimmy.previous.force";
    public static final String NEXT_ACTION = "fcom.sublime.zimmy.next";
    public static final String REPEAT_ACTION = "com.sublime.zimmy.repeat";
    public static final String SHUFFLE_ACTION = "com.sublime.zimmy.shuffle";
    public static final String FROM_MEDIA_BUTTON = "frommediabutton";
    public static final String REFRESH = "com.sublime.zimmy.refresh";
    public static final String UPDATE_LOCKSCREEN = "com.sublime.zimmy.updatelockscreen";
    ...
    private static final String SHUTDOWN = "com.sublime.zimmy.shutdown";
